...
import { IPrintInvoiceSingle } from "../interface";

function PrintInvoice({ invoice, invoiceRef }: IPrintInvoiceSingle) {
  return (
    <div>
      <div
        ref={invoiceRef}
      ...
      >
        ...
        <div className="flex justify-between mb-4 items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex">
              ...
              {new DateObject(invoice.updated_at).convert(persian, persian_fa).format("YYYY/MM/DD")}
            </div>
          </div>
        </div>
        {/* company info */}
        ...
        <table className="text-center w-full mt-2">
          <thead>
            <tr>
              <th colSpan={5} className="border border-asiatech-gray-500 py-1 bg-asiatech-gray-400">
                مشخصات پرداخت
              </th>
            </tr>
          </thead>
          ...
          <thead>
            <tr>
              ...
              <th className="border border-asiatech-gray-500 py-1 bg-asiatech-gray-400">درگاه</th>
              <th className="border border-asiatech-gray-500 py-1 bg-asiatech-gray-400">
                شناسه پرداخت
              </th>
              <th className="border border-asiatech-gray-500 py-1 bg-asiatech-gray-400">مبلغ</th>
            </tr>
          </thead>
          <tbody>
            <tr>
